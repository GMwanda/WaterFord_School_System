                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="phone_number" type="text" class="form-control @error('Phone Number') is-invalid @enderror" name="phone_number" required autocomplete="phone_number">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="userrole" type="number" class="form-control" name="userrole" required autocomplete="userrole" placeholder="(0=Student) (2=lec) (1=Admin)">
                            </div>
                        </div>
