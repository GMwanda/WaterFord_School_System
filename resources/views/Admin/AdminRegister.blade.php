                    ...
                    <div class="card-body">
                        <form method="POST" action="/addUser" >
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="phone_number" type="text"
                                        class="form-control @error('Phone Number') is-invalid @enderror" name="phone_number"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="is_admin" type="number" class="form-control" name="is_admin" 
                                        autocomplete="is_admin" value="0" placeholder="(0=Student) (2=lec) (1=Admin)">
                                </div>
                            </div>
