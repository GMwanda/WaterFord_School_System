...
<div class="flex flex-col justify-center items-center">
    ...
    <form class="flex flex-col items-center border border-red-700 h-96 my-11 px-5 py-3 rounded-md shadow-sm" action="">
        ...
        <div class="my-4">
            ...
            <input class=" w-56 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none" id="file_input" type="file">
        </div> <br>
        <button id="s_btn" class="btn bg-cyan-700 text-white hover:scale-75 transition duration-150 ease-in-out delay-150">Submit</button>
    </form>
</div>
