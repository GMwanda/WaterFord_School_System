...
<div class="flex flex-col justify-center items-center">
    ...
    <form class="flex flex-col items-center border border-red-700 h-3/5 my-11 px-5 py-3 rounded-md shadow-sm" action="{{ url('/announcement/upload') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="my-4">
        ...
        <button type="submit" id="s_btn" class="btn text-white hover:scale-75 transition duration-150 ease-in-out delay-150">Submit</button>
    </form>
</div>
