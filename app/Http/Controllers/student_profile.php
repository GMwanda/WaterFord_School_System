...
class student_profile extends Controller
{
    ...
    public function getstudents_profile()
    {
        ...
        $id = Auth::user()->id;
        $st['students']= st_model::where('id', $id)->first();
        return view('/students/studentsdetails')->with("st",$st);
        // return $st;
    }
...
public function assignments()
    {
        $id =  Auth::user()->id;
        $r = Student::where('UserId', $id)->value('CourseEnrolled');
        $as = Assignments::where('CourseId', '=', $r)->get();
        // return $as;
        return view('/students/assignments')->with("as", $as);
    }
